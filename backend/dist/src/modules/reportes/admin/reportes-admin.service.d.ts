...
import { ReporteQuery } from './dto/reporte-query.dto';
export declare class ReportesAdminService {
    private prisma;
    ...
    getInventario(_query: ReporteQuery): Promise<{
        kpis: {
    ...
    private evolucionPorDia;
    private topProductosVendidos;
    private topClientes;
}
