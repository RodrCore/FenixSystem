...
export declare class ReabastecimientoService {
    private prisma;
    ...
    create(dto: any, usuarioId: number, rolActual: string): Promise<{
        proveedor: {
            id: number;
            razon_social: string;
        };
    ...
    recibir(id: number, detallesRecibidos: any[], usuarioId: number, rolActual: string): Promise<{
        proveedor: {
            id: number;
            activo: boolean;
            created_at: Date;
    ...
    cancelar(id: number, motivo: string, usuarioId: number, rolActual: string): Promise<{
        id: number;
        created_at: Date;
        updated_at: Date;
        estado: import("@prisma/client").$Enums.EstadoReabastecimiento;
    ...
    getSugerenciasBajoStock(): Promise<{
        id: number;
        nombre: string;
        codigo_interno: string | null;
        stock_actual: number;
