    ...
    try {
        ...
        const usuarioGerente = await prisma.usuario.upsert({
            ...
            create: {
                ...
                salario_base: new library_1.Decimal('2500000'),
                comision_porcentaje: new library_1.Decimal('5.0'),
                estado: true,
            },
        });
        ...
        const usuarioPreventista = await prisma.usuario.upsert({
            ...
            create: {
                ...
                salario_base: new library_1.Decimal('1800000'),
                comision_porcentaje: new library_1.Decimal('8.0'),
                estado: true,
            },
        });
        ...
        const usuarioAlmacen = await prisma.usuario.upsert({
            ...
            create: {
                ...
                salario_base: new library_1.Decimal('1600000'),
                estado: true,
            },
        });
        ...
        const usuarioRepartidor = await prisma.usuario.upsert({
            ...
            create: {
                ...
                salario_base: new library_1.Decimal('1400000'),
                comision_porcentaje: new library_1.Decimal('3.0'),
                estado: true,
            },
        });
